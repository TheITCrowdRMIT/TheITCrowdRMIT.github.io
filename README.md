...
From group perspectives, our overall work process is quite well and smooth.  Sophie as a leader helps to work group very effectively.  After we done formation, she formed a detailed work plan based on group discussion. We all experienced the power of an effective work plan with details and small deadlines during A2 complete process. She was responsible to monitor that the work is organized to get it done.  It really will help the group to get organized from the very beginning. Sophie created a group repository on Github and share the link with us, then every group members are able to upload our own tasks on it. We regularly checks group work progress to ensure everyone follow the plan in a timely manner. The following pictures shows the commits history that we did before. During the tenure of working together, situations cropped up on member’s enthusiasm for participation, for example, ignore text message or something like that. However, thankfully after we have a serious group meeting, everything was becoming better,
Even though someone busy or no time to discuss on communication platform, they will just spend a few seconds to reply something simply to indicate they will check the info or do the task later when they get free time.
Even though the assignment 2 completed process was broken up into individual pieces and equally distributed to each group members, we often consulted with one another when we ran into difficulties with our work.
 We all believe group work did help us to develop better communication skills and build some self-knowledge about what difficulties we may face and how we can overcome them. Working in group did allow us to build some professional knowledge about skills we already have and some skills that we need to develop. As a result we managed to achieve a strong outcome thus improving enhancing our competencies, knowledge and empowering group as a whole.
